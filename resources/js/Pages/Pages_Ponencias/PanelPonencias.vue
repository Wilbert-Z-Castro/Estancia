                        ...
                        <div class="flex flex-col justify-between p-4 leading-normal w-full ">
                            ...
                            <div class="flex flex-col sm:flex-row  justify-left items-center sm:items-center mb-2" >
                                <div class="">
                                    ...
                                    <button v-show="a.Estado=='Terminado'" @click="Imprimir(a)" type="button" class="focus:outline-none text-white bg-yellow-400 hover:bg-yellow-500 focus:ring-4 focus:ring-yellow-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:focus:ring-yellow-900">Imprimir Reconocimiento</button>
                                </div>
                            </div>
                        </div>                      
                    </div>
